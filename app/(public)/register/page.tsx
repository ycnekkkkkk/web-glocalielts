...
import { ArrowLeft, ArrowRight, CheckCircle2, Eye, EyeOff, Lock, Mail, ShieldCheck, Sparkles, User } from "lucide-react";
      ...
      <div className="hidden lg:flex flex-col justify-between relative overflow-hidden w-1/2 bg-slate-900 text-white p-8 xl:p-12 border-r border-slate-800 selection:bg-brand-500/30">
        ...
        <div className="relative z-10 max-w-lg my-auto py-4">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-300 text-[10px] font-bold uppercase tracking-wider mb-4">
            ...
            <span>KHỞI ĐẦU HÀNH TRÌNH CHINH PHỤC IELTS</span>
          </div>

          <h1 className="text-2xl xl:text-3xl font-extrabold text-white tracking-tight leading-snug mb-3">
            Tạo tài khoản học viên IELTS chuẩn quốc tế
          </h1>

          <p className="text-xs xl:text-sm text-slate-300 leading-relaxed mb-6">
            Khám phá phòng thi thử 4 kỹ năng miễn phí, tài liệu học thuật cập nhật liên tục từ Cambridge 15–19 và được cố vấn học vụ xây dựng lộ trình học tập tối ưu.
          </p>
          ...
          <div className="space-y-3 text-xs xl:text-sm text-slate-200">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-medium">Test năng lực 4 kỹ năng miễn phí chuẩn Cambridge</span>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-4.5 h-4.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center shrink-0">
                <CheckCircle2 className="w-3 h-3 text-emerald-400" />
              </div>
              <span className="font-medium">Nhận xét và phân tích chi tiết tiêu chí Writing & Speaking</span>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-4.5 h-4.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center shrink-0">
                <CheckCircle2 className="w-3 h-3 text-emerald-400" />
              </div>
              <span className="font-medium">Lộ trình kèm 1-on-1 sát sao cùng đội ngũ giảng viên 8.0+</span>
            </div>
          </div>
        </div>

        {/* Bottom: Community Trust Note */}
        <div className="relative z-10 rounded-xl bg-white/5 border border-white/10 p-3.5 xl:p-4 backdrop-blur-sm">
          <p className="text-xs text-slate-300 leading-relaxed italic">
            “Hơn 15.000+ học viên đã tin tưởng và nâng band điểm thành công cùng hệ sinh thái đào tạo & khảo thí Glocal IELTS.”
          </p>
          <div className="mt-2.5 pt-2.5 border-t border-white/10 flex items-center justify-between text-[10px] text-slate-400 font-medium">
            <span className="text-slate-300 font-semibold">Đối tác Khảo thí IDP & British Council</span>
            <span>Cam kết Chuẩn đầu ra</span>
          </div>
        </div>
      </div>

      {/* ── 2. RIGHT PANEL: CLEAN REGISTER FORM ── */}
        ...
        <div className="w-full max-w-md mx-auto my-auto">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">
              Bắt đầu hành trình học tập và thi thử IELTS chuẩn hóa ngay hôm nay.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 my-3">
            ...
            <span className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">hoặc đăng ký email</span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <p className="text-[10px] text-slate-400 leading-relaxed pt-0.5">
              ...
              <Link href="#" className="text-slate-600 hover:text-brand-600 font-medium underline underline-offset-2">
                Điều khoản dịch vụ
              </Link>{" "}
              và{" "}
              <Link href="#" className="text-slate-600 hover:text-brand-600 font-medium underline underline-offset-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-10.5 mt-1 flex items-center justify-center gap-2 rounded-xl bg-brand-600 hover:bg-brand-700 active:bg-brand-800 text-white text-xs sm:text-sm font-bold px-4 transition-all shadow-sm hover:shadow cursor-pointer disabled:opacity-60 focus:outline-none focus:ring-4 focus:ring-brand-500/20"
            >
              {loading ? (
                <div className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />
              ) : null}
              <span>{loading ? "Đang tạo tài khoản..." : "Tạo tài khoản miễn phí"}</span>
